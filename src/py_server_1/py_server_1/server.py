# Fundamentals of Mobile Robot - AUT.710
# Exercise 01 Problem 03
...
line1, = ax.plot(0, 0, 'b+', markersize=2, label="Forward Euler")
line2, = ax.plot(0, 0, 'r--', linewidth=1, label="Midpoint")
ax.legend()
